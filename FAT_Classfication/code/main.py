...
parser.add_argument("--onelayer_out_channels",type=int,default=32,help="Conv1D_output_channels")
parser.add_argument("--twolayer_out_channels",type=int,default=64,help="Conv1D_output_channels")
parser.add_argument("--final_out_channels",type=int,default=128,help="Conv1D_output_channels")
...
parser.add_argument("--CNNoutput_channel",type=int,default=10,help="CNNoutput_channel")
parser.add_argument("--ft_dropout",type=float,default=0,help="finetune_dropout")
parser.add_argument("--num_classes_target",type=int,default=0,help="target dataset class number")
parser.add_argument("--hidden_dimension",type=int,default=1280,help="hidden dimension")
...
def main(args, configs, seed=None):
    ...
    # Load datasets
    sourcedata_path = f"./dataset/{sourcedata}"
    ...
    experiment_log_dir = os.path.join(logs_save_dir, experiment_description, run_description,
                                      training_mode + f"_{seed}_pt_{masking_ratio}_{pretrain_lr}_{pretrain_epoch}_ft_{lr}_{finetune_epoch}_expname_{exp_name}")
